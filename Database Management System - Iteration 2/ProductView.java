...
public class ProductView extends JFrame{
    ...
    public ProductView() {
        ...
        panelProductInfo.add(new JLabel("Expiration Date: "));
        panelProductInfo.add(txtProductExpirationDate);
        txtProductQuantity.setHorizontalAlignment(JTextField.RIGHT);
        
        panelProductInfo.add(new JLabel("Supplier: "));
        panelProductInfo.add(txtProductSupplier);
        txtProductQuantity.setHorizontalAlignment(JTextField.RIGHT);
        
        panelProductInfo.add(new JLabel("Unit: "));
        panelProductInfo.add(txtProductUnit);
        txtProductQuantity.setHorizontalAlignment(JTextField.RIGHT);
    ...
    public JTextField getTxtProductExpirationDate() {
        return txtProductExpirationDate;
    }
