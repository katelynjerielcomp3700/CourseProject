...
public class CheckoutView extends JFrame{
    ...
    private JButton btnReceiptTxt = new JButton("Generate Receipt (Text)");
    private JButton btnReceiptHtm = new JButton("Generate Receipt (HTML)");
    ...
    public void switchInterface() {
        ...
        JPanel panelReceiptButtons = new JPanel();
        panelReceiptButtons.add(btnReceiptTxt);
        panelReceiptButtons.add(btnReceiptHtm);
        this.getContentPane().add(panelReceiptButtons);
    }
    ...
    public JButton getBtnReceiptTxt() {
        return btnReceiptTxt;
    }
    
    public JButton getBtnReceiptHtm() {
        return btnReceiptHtm;
    }
